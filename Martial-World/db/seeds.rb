...
Art.create([{
    ...
    The quarterstaff has some advantages over the longsword; it is visually nonthreatening but can be just as deadly, and will even be more dangerous to an armored person than a longsword.[1]
...
"
    ...
    founder_img: "https://upload.wikimedia.org/wikipedia/commons/7/79/Tire_Mach%C3%A8t.jpg",
    style: "Weapon",
